...
fun KonanTarget.supportsLibBacktrace(): Boolean =
        this.family.isAppleFamily ||
                ...
                ((this.family == Family.LINUX || this.family == Family.OHOS) && this.architecture !in listOf(Architecture.MIPS32, Architecture.MIPSEL32)) ||
...
fun KonanTarget.supportsGccUnwind(): Boolean = family == Family.ANDROID || family == Family.LINUX || family == Family.OHOS || this is KonanTarget.MINGW_X86
